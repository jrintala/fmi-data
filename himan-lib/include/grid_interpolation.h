...
class interpolation_kernel
{
	...
	friend void interpolate(std::vector<double>& target, const std::vector<double>& source, const interpolation_kernel& kernel);
...
std::vector<double> get_weights(const himan::point& a, const himan::point& b, const himan::point& c, const himan::point& d, const himan::point& p);
